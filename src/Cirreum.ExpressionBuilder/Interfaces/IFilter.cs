...
public interface IFilter {
	...
	/// <summary>
	/// Add an <see cref="IFilterStatement"/> object that defines the filter.
	/// </summary>
	/// <param name="statement">The <see cref="IFilterStatement"/> object that defines the filter.</param>
	/// <returns>A <see cref="FilterStatementConnection"/> object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By(IFilterStatement statement);
	...
	/// <returns>A <see cref="FilterStatementConnection"/> object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By(string propertyId, IOperator operation);
	...
	IFilterStatementConnection By(string propertyId, IOperator operation, Connector connector);
	...
	/// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By<TPropertyType>(string propertyId, IOperator operation, TPropertyType value);
	...
	/// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
	/// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By<TPropertyType>(string propertyId, IOperator operation, TPropertyType value, Connector connector);
	...
	/// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By<TPropertyType>(string propertyId, IOperator operation, TPropertyType value, TPropertyType value2);
	...
	/// <param name="connector">Establishes how this filter statement will connect to the next one.</param>
	/// <returns>A FilterStatementConnection object that defines how this statement will be connected to the next one.</returns>
	IFilterStatementConnection By<TPropertyType>(string propertyId, IOperator operation, TPropertyType value, TPropertyType value2, Connector connector);
