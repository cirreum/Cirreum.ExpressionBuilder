...
public class In : OperatorBase {
	...
	private static MethodCallExpression? GetExpressionHandlingNullables(MemberExpression member,
		...
		if (listUnderlyingType is not null && memberUnderlingType is null && member.Expression is not null) {
